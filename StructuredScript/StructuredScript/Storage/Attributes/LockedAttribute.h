...
#ifndef STRUCTURED_SCRIPT_LOCKED_ATTRIBUTE_H
#define STRUCTURED_SCRIPT_LOCKED_ATTRIBUTE_H

#include "../../Common/NodeQuery.h"

namespace StructuredScript{
	namespace Storage{
		class LockedAttribute : public IMemoryAttribute{
		public:
...
#endif /* !STRUCTURED_SCRIPT_LOCKED_ATTRIBUTE_H */